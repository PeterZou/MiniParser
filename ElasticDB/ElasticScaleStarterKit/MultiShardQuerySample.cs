...
namespace ElasticScaleStarterKit
{
    internal static class MultiShardQuerySample
    {
        public static void ExecuteMultiShardQuery(RangeShardMap<int> shardMap, string credentialsConnectionString)
        {
            ...
            ExecuteMultiShardQuery(shardMap, credentialsConnectionString);
        }

        public static void ExecuteMultiShardQuery(ListShardMap<int> shardMap, string credentialsConnectionString)
        {
            IEnumerable<Shard> shards = shardMap.GetShards();
            ExecuteMultiShardQuery(shards, credentialsConnectionString);
        }

        public static void ExecuteMultiShardQuery(IEnumerable<Shard> shards, string credentialsConnectionString)
        {
